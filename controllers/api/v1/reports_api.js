...
module.exports.createReport = async function(req,res)
{
    try {
        ...
        let reportCreated = await Report.create({doctor:req.user._id,
        ...
        let reportFound= await Report.findById(reportCreated._id).populate('doctor');
...
//FIND ALL REPORTS OF A PARTICULAR PATIENT.
